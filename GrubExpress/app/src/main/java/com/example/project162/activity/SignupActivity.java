...
public class SignupActivity extends BaseActivity {
    ...
    private void setVariable() {
        Button b1 = binding.SignUpbtn;
        EditText name = binding.editTextText;
        EditText Email = binding.editTextTextEmailAddress2;
        EditText Pass = binding.editTextTextPassword;
        EditText confirmPass = binding.editTextTextPassword2;
        ProgressBar pBar = binding.progressBar;
